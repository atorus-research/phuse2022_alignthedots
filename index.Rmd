...
- What is the `f_str()` (pronounced "f string")
  - An object to hold metadata around a string format
  - You can get a lot of metadata out of a small bit of information
- What does an `f_str()` look like
  - Let's say you wanted to format the variables `hp` and `wt` from mtcars
  - `f_str('xxx (x.xx)', hp, wt)`
- What information can we get out of that? A lot!
  ...
  - And more! 
- Tplyr uses this information to do _a lot_
